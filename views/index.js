...
_dataSource.AppDataSource.initialize().then( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  var app;
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          // create express app
          app = express(); // const mysql = require("mysql2");

          app.use(bodyParser.json()); // register express routes from defined application routes
          ...
          app.listen(3000); // insert new users for test

          _context.next = 6;
          return _dataSource.AppDataSource.manager.save(_dataSource.AppDataSource.manager.create(_User.User, {
            firstName: "Timber",
            lastName: "Saw",
            age: 27
          }));
